...
--
-- Host: localhost
-- Waktu pembuatan: 21 Sep 2020 pada 17.35
...
INSERT INTO `barang` (`id`, `kode_barang`, `nama_barang`, `harga_barang`) VALUES
(1, '123', 'BARANG 1', 12000),
(2, 'AW4863', '2/1 Twill', 2880),
(3, 'AW 1338', 'Canvas', 2240),
(4, 'AW 330', 'Canvas', 2100),
(5, 'AW 309', 'Canvas', 2240),
(6, 'SF 77', '3/1 Twill', 3450);
...
(27, NULL, 'DO20SEP0001', '2020-09-20', NULL, '15', NULL, NULL, NULL, NULL, NULL, NULL);
...
(22, NULL, 'I20SEP0001', '2020-09-20', NULL, 15, NULL, NULL, NULL, NULL, NULL, NULL);
...
('rincian-5f671020aa35f', 27, 100),
('rincian-5f67106492fbf', 27, 100);
...
INSERT INTO `sales_order` (`id`, `id_barang`, `qty`, `no_so`, `so_date`, `ship_date`, `customer`, `ship_to`, `no_telp`, `validasi`) VALUES
(15, 3, 3000, 'SO15SEP0001', '2020-09-15', '2020-09-21', '33', 'Bandung', 227533187, 'valid'),
(19, 3, 12, 'SO20SEP0001', '2020-09-20', '2020-09-21', '34', 'jakarta', 324324, 'valid');
...
(23, 'admin_penjualan', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', 'nrisma257@gmail.com', 'Kinanti Fatwa Mustika', 'Admin Penjualan'),
(27, 'staff_produksi', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', 'nrisma257@gmail.com', 'Cecille', 'Staff Produksi'),
(28, 'direktur', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', 'nrisma257@gmail.com', 'Yoon Kihan', 'Direktur'),
