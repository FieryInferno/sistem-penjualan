...
<html lang="en" class="loading">
  ...
  <head>
    <?php 
      ...
      $dataPage = array(
        'title' => 'Laporan - Sales Order | Penjualan',
        'sidebar_title' => 'Laporan',
        'sidebar_subtitle' => 'Laporan Sales Order'
      );
    ?> 
        ...
        <form id="form_filter_harian">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="hidden" name="kolom" value="so_date">
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-11">
            <h4 class="card-title mb-0">Laporan Hasil Pencarian | Sales Order</h4>
          </div>
          <div class="col-1">
            <form action="<?= base_url('Laporan_c/cari_laporan/sales_order'); ?>" method="post">
              <input type="hidden" name="kolom" value="so_date">
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Laporan Hari Ini (Tanggal <?php echo date('d') ?>) | Sales Order</h4>
      </div>
      <div class="card-body table-responsive">
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Laporan Bulan Ini (Bulan <?php echo date('m'); ?>) | Sales Order</h4>
      </div>
      <div class="card-body table-responsive">
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Laporan Tahun Ini (Tahun <?php echo date('Y'); ?>) | Sales Order</h4>
      </div>
      <div class="card-body table-responsive">
    ...
    <script type="text/javascript">
      ...
      function getData() {
        $.ajax({
          type: "post",
          dataType: "json",
          url: base_url+'Laporan_c/getData/sales_order',
          data: {kolom: 'so_date',hari: '<?php echo date('d'); ?>', bulan: '<?php echo date('m'); ?>', tahun: '<?php echo date('Y'); ?>'},
          beforeSend: function() {
          ...
          success: function (resp) {
            ...
            $.each(resp.laporanHarian, function(i,item) {  
              ...
              isi_tbody_harian += '<tr><td>'+no+'</td><td>'+item.no_so+'</td><td>'+item.nama_pelanggan+'</td><td>'+item.ship_to+'</td><td>'+item.kode_barang+'</td><td>'+item.nama_barang+'</td><td>'+rupiah1+'</td><td>Rp '+rupiah2+'</td><td>Rp '+rupiah+'</td></tr>';
              no++;
            });
            // End Harian
            ...
            $.each(resp.laporanBulanan, function(i,item) {  
              ...
              isi_tbody_bulanan += '<tr><td>'+no1+'</td><td>'+item.no_so+'</td><td>'+item.nama_pelanggan+'</td><td>'+item.ship_to+'</td><td>'+item.kode_barang+'</td><td>'+item.nama_barang+'</td><td>'+rupiah1+'</td><td>Rp '+rupiah2+'</td><td>Rp '+rupiah+'</td></tr>';
              no1++;
            });
            // End Bulanan
            ...
            $.each(resp.laporanTahunan, function(i,item) {  
              ...
              isi_tbody_tahunan += '<tr><td>'+no2+'</td><td>'+item.no_so+'</td><td>'+item.nama_pelanggan+'</td><td>'+item.ship_to+'</td><td>'+item.kode_barang+'</td><td>'+item.nama_barang+'</td><td>'+rupiah1+'</td><td>Rp '+rupiah2+'</td><td>Rp '+rupiah+'</td></tr>';
              no2++;
            });
            // End Tahunan
      ...
      $("#form_filter_harian").submit(function() {
        ...
        $.ajax({
          type: 'post',
          url: base_url+'Laporan_c/cari_laporan/sales_order',
          data: $(this).serialize(),
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(resp) {
            ...
            $.each(resp, function(i,item) {  
              ...
              isi_tbody_filter += '<tr><td>'+no3+'</td><td>'+item.no_so+'</td><td>'+item.nama_pelanggan+'</td><td>'+item.ship_to+'</td><td>'+item.kode_barang+'</td><td>'+item.nama_barang+'</td><td>'+rupiah1+'</td><td>Rp '+rupiah2+'</td><td>Rp '+rupiah+'</td></tr>';
              no3++;
            });
