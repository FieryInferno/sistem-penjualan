  ...
  <head>
    <?php 
      ...
      $dataPage = array(
        ...
        'sidebar_subtitle' => 'Laporan Invoice'
      );
    ?> 
        ...
        <form id="form_filter_harian">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="hidden" name="kolom" value="invoice_date">
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-11">
            <h4 class="card-title mb-0">Laporan Hasil Pencarian | Invoice</h4>
          </div>
          <div class="col-1">
            <form action="<?= base_url('Laporan_c/cari_laporan/invoice'); ?>" method="post">
              <input type="hidden" name="kolom" value="invoice_date">
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Laporan Hari Ini (Tanggal <?php echo date('d') ?>) | Invoice</h4>
      </div>
      <div class="card-body table-responsive">
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Laporan Bulan Ini (bulan <?php echo date('m'); ?>) | Invoice</h4>
      </div>
      <div class="card-body table-responsive">
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Laporan Tahun Ini (Tahun <?php echo date('Y'); ?>) | Invoice</h4>
      </div>
      <div class="card-body table-responsive">
    ...
    <script type="text/javascript">
      ...
      function getData() {
        $.ajax({
          type: "post",
          dataType: "json",
          url: base_url+'Laporan_c/getData/invoice',
          data: {kolom: 'invoice_date',hari: '<?php echo date('d'); ?>', bulan: '<?php echo date('m'); ?>', tahun: '<?php echo date('Y'); ?>'},
          beforeSend: function() {
      ...
      $("#form_filter_harian").submit(function() {
        ...
        $.ajax({
          type: 'post',
          url: base_url+'Laporan_c/cari_laporan/invoice',
          data: $(this).serialize(),
          dataType: 'json',
          beforeSend: function() {
