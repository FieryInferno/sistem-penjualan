...
<body>
	...
	<div>
		<table>
			<tbody>
				...
				<tr>
					<td style="width: 290px;line-height:20px;"><?= $so['nama_pelanggan']; ?></td>
				</tr>
				<tr>
					<td style="width: 290px;line-height:20px;"><?= $so['ship_to']; ?></td>
				</tr>
				<tr>
					<td style="width: 290px;line-height:20px;"><?= $so['no_telp']; ?></td>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<table style="border:1px solid #000000;" border="1" align="center" width="600px" cellspacing="3">
		...
		<tr style="border:1px solid #000000;">
			...
			<td style="font-size:12px;border:1px solid #000000;" class="text-center"><?= $so['nama_barang']; ?></td>
			<td style="font-size:12px;border:1px solid #000000;" class="text-center"><?= $so['qty']; ?></td>
			<?php
			...
			?>
			<td style="font-size:12px;border:1px solid #000000;" class="text-center"><?= rupiah($so['harga_barang']); ?></td>
			<td style="font-size:12px;border:1px solid #000000;" class="text-center"><?= rupiah($so['harga_barang'] * $so['qty']); ?></td>
		</tr>
	</table>
	<br>
	<br>
