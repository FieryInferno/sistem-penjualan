...
<html lang="en" class="loading">
  ...
  <head>
    <?php 
      ...
      $dataPage = array(
        'title' => 'Transaksi - Delivery Order | Penjualan',
        'sidebar_title' => 'Transaksi',
        'sidebar_subtitle' => 'Delivery Order'
      );
    ?> 
  ...
  <div class="col-md-12"> 
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0"><i class="fa fa-plus"></i> Tambah | Form Delivery Order</h4>
      </div>
      <div class="card-body">
        <form id="form_tambah">
          <div class="row">
              ...
              <div class="row">
                <div class="col-md-6"> 
                  <fieldset class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_do" id="no_do" placeholder="Masukkan No. DO" required="" oninvalid="this.setCustomValidity('Harap Masukkan No. DO')" oninput="setCustomValidity('')">
                  </fieldset> 
                </div>
                <div class="col-md-6">
                  <fieldset class="form-group">
                    <label for="do_date">DO Date :</label>
                    <input type="text" class="form-control" name="do_date" id="do_date" required="" oninvalid="this.setCustomValidity('Harap Isi DO Date')" oninput="setCustomValidity('')">
                  </fieldset> 
                </div>
              </div>
              <fieldset class="form-group">
            ...
            <div class="col-md-6 col-xs-12">
              <?php $validasiTambah = ""; ?>
              <?php if($level == "Admin Penjualan") { $validasiTambah = "hidden"; }?>
              <div class="form-group">
                <div class="custom-control custom-checkbox m-0" <?php echo $validasiTambah; ?>>
                    <input type="checkbox" class="custom-control-input" name="validasi" id="validasi" value="valid">
                    <label class="custom-control-label" for="validasi">Validasi</label>
                </div>
              </div>
            </div>
          </div>   
...
<div class="row" id="editPage" hidden="">
  <div class="col-md-12"> 
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0"><i class="fa fa-pencil"></i> Edit | Form Delivery Order</h4>
      </div>
      <div class="card-body">
        <form id="form_edit">
          <div class="row">
            <div class="col-md-6 col-xs-12"> 
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="hidden" name="no_do_awal">
                ...
                <div class="col-md-6">
                  <fieldset class="form-group">
                    <label for="do_date">DO Date :</label>
                    <input type="date" class="form-control" name="do_date" id="do_date" required="" oninvalid="this.setCustomValidity('Harap Isi DO Date')" oninput="setCustomValidity('')">
                  </fieldset> 
                </div>
              </div>
              <fieldset class="form-group">
...
<div class="row" id="editShipPage" hidden="">
  <div class="col-md-12"> 
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0"><i class="fa fa-pencil"></i> Rincian Barang | Form Delivery Order</h4>
      </div>
      <div class="card-body">
        <form id="form_rincian_barang">
          <div class="row">
            <div class="col-md-6 col-xs-12"> 
              <div class="row">
                <div class="col-md-6">
                  <input type="hidden" name="id_delivery_order" id="id_delivery_order"> 
                </div>
                <div class="col-md-6"> 
                </div>
              </div> 
              <div class="row"> 
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="roll">Roll ke- :</label>
                    <input type="number" class="form-control" name="roll_ke" id="roll_ke" required="" oninvalid="this.setCustomValidity('Harap Isi Ship Date')" oninput="setCustomValidity('')" readonly>
                  </div> 
                </div>
                <div class="col-md-6">
                  <fieldset class="form-group">
                    <label for="ship_to">Panjang :</label>
                    <input type="number" class="form-control" name="panjang" id="panjang" placeholder="Panjang Roll" required="" oninvalid="this.setCustomValidity('Masukan Panjang per Roll')" oninput="setCustomValidity('')">
                  </fieldset> 
                </div>
              </div> 
            </div> 
          ...
          <button type="button" class="btn btn-danger cancel-ship-btn"><i class="ft-x"></i> Batal</button>
        </form>
        <table class="table table-striped table-rincian-barang">
          <thead>
            <tr>
              <th>Nama Barang</th>
              <th>1</th>
...
<div class="row slideRight-1">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Delivery Order</h4>
      </div>
            ...
            <tr>
              <?php
                if ($level == 'Admin' || $level == 'Admin Penjualan') { ?>
                  ...
                  <th></th>
                  <th></th>
                <?php } else if ($level == 'Staff Produksi') { ?>
      ...
      <div class="modal-content">
        <form id="form_hapus" action=""> 
          <div class="modal-body">
            <input type="hidden" id="id_do_hps" name="id_do"> 
            <input type="hidden" id="no_do_hps" name="no_do"> 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form id="form_verifkasi" action=""> 
          <div class="modal-body">
            <input type="hidden" id="id_do_verifikasi" name="id_do"> 
            <input type="hidden" id="no_do_verifikasi" name="no_do"> 
    ...
    <script type="text/javascript">
      ...
      function getData() {
        $.ajax({
          type: "get",
          dataType: "json",
          url: base_url+'Data_master_c/get_delivery_order',
          beforeSend: function() {
          ...
          success: function (resp) {
            ...
            $.ajax({
              type      : "get",
              dataType  : "json",
              url       : base_url+'Data_master_c/get_no/delivery_order',
              success   : function(res_jml) {
                $("#form_tambah input[name=no_do]").val(res_jml).attr('readonly',true);
              }
            });
            date    = new Date();
            ...
            $("#form_tambah input[name=do_date]").val(tanggal+"/"+bulan+"/"+tahun).attr('readonly',true);
            isi_tbody = "";
            no = 1;
            $.each(resp, function(i,item) {  
              ...
              if(level == "Admin" || level == "Admin Penjualan") {
                ...
                isi_tbody += '<tr>'+
                                ...
                                '<td>Rp '+rupiah+'</td>'+
                                '<td align="center">'+
                                  '<form action="<?= base_url('laporan/delivery_order'); ?>" method="post">'+
                                    '<input type="hidden" value="'+item.id_delivery_order+'" name="id_do">'+
                                    '<button type="button" class="btn btn-raised btn-outline-info mr-1" id_do = "'+item.id_delivery_order+'" no_do = "'+item.no_do+'" onclick="editPage(this)"><i class="fa fa-pencil"></i> Edit</button>'+
                                    '<button type="submit" class="btn btn-raised btn-outline-primary mr-1"><i class="fa fa-print"></i> Print</button>'+
                                    '<button type="button" class="btn btn-raised btn-outline-danger mr-1" id_do = "'+item.id_delivery_order+'" no_do = "'+item.no_do+'" onclick="modalHapus(this)"><i class="fa fa-remove"></i> Del</button>'+
                                  '</form>'+
                                '</td>'+
                              '</tr>'; 
              } else {
                if(item.validasi_do == 'valid') {
                  isi_tbody += `<tr>
                                  ...
                                  <td>Rp ${rupiah}</td>
                                  <td align="center">
                                    <button type="button" class="btn btn-raised btn-outline-success mr-1"><i class="fa fa-check"></i></button>
                                    <button type="button" class="btn btn-raised btn-outline-primary mr-1" id_do = "${item.id_delivery_order}" no_do = "${item.no_do}" onclick="editPageShip(this)"><i class="fa fa-edit"></i> Rincian Barang</button>
                                  </td>
                                </tr>`;  
                } else {
                  isi_tbody += '<tr>'+
                                  ...
                                  '<td>Rp '+rupiah+'</td>'+
                                  '<td align="center">'+
                                    '<button type="button" class="btn btn-raised btn-outline-success mr-1" id_do = "'+item.id_delivery_order+'" no_do = "'+item.no_do+'" onclick="modalVerifikasi(this)"> Verifikasi</button>'+
                                    '<button type="button" class="btn btn-raised btn-outline-primary mr-1" id_do = "'+item.id_delivery_order+'" no_do = "'+item.no_do+'" onclick="editPageShip(this)"><i class="fa fa-edit"></i> Rincian Barang</button>'+
                                  '</td>'+
                                '</tr>'; 
                }
      ...
      function getDataRincianBarang(id_delivery_order) {
        $.ajax({
          type      : "get",
          dataType  : "json",
          url       : base_url+'Transaksi_c/rincian_barang/'+id_delivery_order,
          beforeSend: function() {
            $('.table-rincian-barang').dataTable().fnClearTable();
            $('.table-rincian-barang').dataTable().fnDestroy();
          },
          success: function (resp) {
            isi_tbody       = "";
            a               = [];
            ...
            if (resp.length !== 0) {
              for (let index = 0; index < resp.length; index++) {
                if (index > panjang_row) {
                  panjang_row += 9;
                  index_array += 1;
                  a.push(index_array); 
                  a[index_array]  = [];
                }
                a[index_array].push(resp[index]);
              }
              console.log(a);
              for (let index = 0; index < (a.length+1); index++) {
                ...
                if (index !== a.length) {
                  for (let i = 0; i < a[index].length; i++) {
                    ...
                    rincian_barang  += '<td>'+a[index][i].panjang+'</td>';
                    total           += parseInt(a[index][i].panjang);
                  }
                  if (a[index].length < 10) {
                    for (let j = 0; j < (10 - a[index].length); j++) {
                      rincian_barang  += '<td></td>';
                    }
                  }
                  nama_barang = '<td>'+a[index][0].nama_barang+'</td>';
                  if (index > 0) {
                    nama_barang = '<td></td>';
                  }
                  isi_tbody += '<tr>'+
              ...
              $("#isi_rincian_barang").html(isi_tbody);
            } else {
              $.ajax({
                type      : "get",
                dataType  : "json",
                url       : base_url+'Transaksi_c/dataDoById/'+id_delivery_order,
                success: function (resp) {
                  console.log(resp);
                  isi_tbody = "";
                  isi_tbody = `<tr>
                                <td>${resp[0].nama_barang}</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
            ...
            $('.table-rincian-barang').DataTable({
              "ordering": false
            });
          }
        })
      ...
      $("#form_tambah").submit(function () {
        $.ajax({
          ...
          success: function (e) {
            ...
            $("#form_tambah input[name=no_do]").val("");
            $("#form_tambah input[name=do_date]").val("");
      ...
      $("#form_edit").submit(function () {
        $.ajax({
          ...
          dataType    : "json",
          url         : base_url+'Transaksi_c/edit_do',
          beforeSend  : function() {
            $(".act-btn").html('<span class="spinner-grow spinner-grow-sm" role="status"></span> Loading...').attr('disabled',true);
          },
          success: function (e) {
            if(e == 'error_no_do') {
              toastr.error('Nomor delivery order sudah ada.', 'Gagal Edit Data', {
                "showMethod": "slideDown",
                "hideMethod": "slideUp",
                timeOut: 5000
              });
      ...
      $("#form_rincian_barang").submit(function () {
        var id_delivery_order = $("#id_delivery_order").val();
        $.ajax({
          type      : "post", 
          data      : $("#form_rincian_barang").serialize(),
          dataType  : "json",
          url       : base_url+'Transaksi_c/tambah_rincian_barang',
          beforeSend: function() {
            $(".act-btn").html('<span class="spinner-grow spinner-grow-sm" role="status"></span> Loading...').attr('disabled',true);
          },
          success: function (e) { 
            ...
            $("#form_rincian_barang .act-btn").html('<i class="fa fa-check-square-o"></i> Simpan').attr('disabled',false);
            $.ajax({
              url       : base_url+'Transaksi_c/dataDoById/'+id_delivery_order,
              type      : 'get',
              dataType  : 'json',
              success   : function(resp) {
                $("#form_rincian_barang input[name=id_delivery_order]").val(id_delivery_order);
                if (resp.length == 0) {
                  roll_ke = 1;
                } else {
                  roll_ke = resp.length + 1;
                }
                $("#form_rincian_barang input[name=roll_ke]").val(roll_ke);
              }
            });
            $("#form_rincian_barang input[name=panjang]").val("");
            getDataRincianBarang($("#id_delivery_order").val());
          }
        });
        return false;
      });
      ...
      $("#form_hapus").submit(function () {
        $.ajax({
          ...
          dataType: 'json',
          url: base_url+'Transaksi_c/hapus_do',
          beforeSend: function() {
          ...
          success: function (e) {
            ...
            getData();  
            toastr.info('Delivery Order Bernomor '+e+' telah terhapus.', 'Berhasil Menghapus', {
                "showMethod": "slideDown",
                "hideMethod": "slideUp",
                timeOut: 5000
              });
      ...
      $("#form_verifkasi").submit(function () {
        $.ajax({
          ...
          dataType: 'json',
          url: base_url+'Transaksi_c/verifikasi_do',
          beforeSend: function() {
          ...
          success: function (e) {
            ...
            getData();  
            toastr.success('Delivery Order Bernomor '+e+' telah terverifikasi.', 'Berhasil memverifikasi', {
                "showMethod": "slideDown",
                "hideMethod": "slideUp",
                timeOut: 5000
              });
      ...
      function editPage(e) { 
        $.ajax({
          url: base_url+'Transaksi_c/dataDoById/'+e.getAttribute('id_do'),
          type: 'get',
          dataType: 'json',
          success: function(resp) { 
            $("#form_edit input[name=id_do]").val(resp.id_delivery_order);
            $("#form_edit input[name=no_do_awal]").val(resp.no_do);
            $("#form_edit input[name=no_so_awal]").val(resp.no_so);
            $("#form_edit input[name=no_do]").val(resp.no_do).attr('readonly',true);
            $("#form_edit input[name=do_date]").val(resp.do_date);
      ...
      function editPageShip(e) { 
        $.ajax({
          url       : base_url+'Transaksi_c/rincian_barang/'+e.getAttribute('id_do'),
          type      : 'get',
          dataType  : 'json',
          success   : function(resp) {
            $("#form_rincian_barang input[name=id_delivery_order]").val(e.getAttribute('id_do'));
            if (resp.length == 0) {
              roll_ke = 1;
            } else {
              roll_ke = resp.length + 1;
            ...
            $("#form_rincian_barang input[name=roll_ke]").val(roll_ke);
            $("#editShipPage").attr('hidden',false).addClass('slideDown');
            getDataRincianBarang(e.getAttribute('id_do'));
          }
        });
      }
      ...
      $(".cancel-ship-btn").click(function() { 
        $("#editShipPage").attr('hidden',true);
      });

      function modalHapus(e) {
        $("#id_do_hps").val(e.getAttribute('id_do'));
        $("#no_do_hps").val(e.getAttribute('no_do'));
        $("#pesan_hapus").html('Hapus delivery order bernomor <b>'+e.getAttribute('no_do')+'</b> ?');
        $("#modal_hapus").modal('show');
      }

      function modalVerifikasi(e) {
        $("#id_do_verifikasi").val(e.getAttribute('id_do'));
        $("#no_do_verifikasi").val(e.getAttribute('no_do'));
        $("#pesan_verifikasi").html('Verifikasi delivery order bernomor <b>'+e.getAttribute('no_do')+'</b> ?');
